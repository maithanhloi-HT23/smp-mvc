...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_REQUEST['bkid'])) {		
		if($bookingController->cancelBooking()==true){
			$msg = "Đã hủy đặt hàng thành công ";
		}		
	}

	if (isset($_REQUEST['bckid'])) {
		if($bookingController->bookinged() == true){
			$msg = "Xác nhận đặt hàng thành công ";
		}	
	}
?>
	<!DOCTYPE HTML>
					...
					<div class="agile-tables">
						<div class="w3l-table-info">
							...
							<table id="table">
								...
								<tbody>
									<?php include "../controllers/ShowBooking.php" ?>
								</tbody>
							</table>
						</div>
						</table>
