...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if ($_POST['submit'] == "Update") {
		...
		$pages = new UpdatePage();
		if ($pages->updatePage() == true) {
			$msg = "Dữ liệu trang được cập nhật thành công ";
		} else {
			$error = "Dữ liệu trang cập nhật thành không công";
		}
	}
...
?>
	...
	<head>
		<title>LTQQN | Tạo gói quản trị </title>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
												<option value="" selected="selected" class="form-control">***LỰA CHỌN***</option>
												<option value="manage-pages.php?type=terms">điều khoản và điều kiện</option>
												<option value="manage-pages.php?type=privacy">quyền riêng tư và chính sách </option>
												<option value="manage-pages.php?type=aboutus">Về Chúng Tôi</option>
												<option value="manage-pages.php?type=contact">Liên hệ chúng tôi</option>
											</select>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<?php include "../controllers/ManagePages.php"; ?>
										</div>
									</div>
									<div class="row">
