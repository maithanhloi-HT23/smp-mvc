...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_REQUEST['eid'])) {
		include "../controllers/ReadEnquiry.php";
		$enquiry = new ReadEnquiry();
		if($enquiry->readEnquiry() == true){
	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard.php">Trang chủ</a><i class="fa fa-angle-right"></i>Quản lý yêu cầu </li>
				</ol>
					...
					<div class="agile-tables">
						<div class="w3l-table-info">
							...
							<table id="table">
								...
								<tbody>
									<?php include "../controllers/ShowEnquiry.php"; ?>
								</tbody>
							</table>
						</div>
						</table>
