...
// Code for change password	
    if (isset($_POST['submit'])) {
        require '../controllers/Change-PasswordController.php';
        $changePass = new ChangePasswordController();
        if ($changePass->changePassword() == true) {
        ...
        <body>
            <div class="page-container">
                ...
                <div class="left-content">
                    ...
                    <!--heder end here-->
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Trang Chủ</a><i class="fa fa-angle-right"></i>Thay Đổi Mật Khẩu</li>
                    </ol>
                    <!--grid-->
                    <div class="grid-form">
                            ...
                            <div class="panel-body">
                                <form  name="chngpwd" method="post" class="form-horizontal" onSubmit="return valid();">
                                    ...
                                    <div class="col-sm-8 col-sm-offset-2">
                                        <button type="submit" name="submit" class="btn-primary btn">Hoàn Thành</button>
