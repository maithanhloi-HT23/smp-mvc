    ...
    <div class="page-container">
        ...
        <div class="left-content">
            <div class="mother-grid-inner">
                ...
                <!--header end here-->
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="dashboard.php">Trang Chủ</a> <i class="fa fa-angle-right"></i></li>
                </ol>
                <!--four-grids here-->
                ...
                <div class="four-grids">
                    <div class="col-md-3 four-grid">
                        <div class="four-w3ls">
                            ...
                            <div class="four-text">
                                <h3>Yêu cầu đã giải quyết </h3>
                                <?php
                                require "../models/Issues.php";
                                $issues = new Issues();
                                $cnt4 = $issues->getCoutIssues();
                                ?>
