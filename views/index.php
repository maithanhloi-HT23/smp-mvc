...
<html>
    <head>
        <title>LTQQN | Hệ Thống Bán Hàng </title>
    ...
    <body>
        ...
        <div class="container">
            <div class="rupes">
                <div class="col-md-4 rupes-left wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
                    ...
                    <div class="rup-rgt">
                        <h3>UP TO 1000000VND OFF</h3>
                        <h4><a href="#">MUA HÀNG THÔNG MINH</a></h4>		
                    </div>
                ...
                <div class="col-md-4 rupes-left wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
                    ...
                    <div class="rup-rgt">
                        <h3>UP TO 30% - 70% OFF</h3>
                        <h4><a href="#">TẠI NGÀY LỄ</a></h4>
                ...
                <div class="col-md-4 rupes-left wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
                    ...
                    <div class="rup-rgt">
                        <h3>FLAT 500000VND OFF</h3>
                        <h4><a href="#">ĐĂNG KÝ TRÊN APP</a></h4>
        ...
        <div class="container">
            <div class="holiday">
                ...
                <div><a href="package-list.php" class="view">Hiển thị thêm Sản phẩm</a></div>
            </div>
            <div class="clearfix"></div>
        </div>
