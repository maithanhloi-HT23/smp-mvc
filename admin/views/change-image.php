...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$product = new PackageController();
		if($product->ChangeImg() == true){
            $msg = "Ảnh đã được thay đổi thành công ";
        } else {
	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="index.php">Trang Chủ</a><i class="fa fa-angle-right"></i>Cập Nhật Ảnh Tour </li>
				</ol>
				<!--grid-->
				<div class="grid-form">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
									<?php include '../controllers/ShowImgPackage.php' ?>
